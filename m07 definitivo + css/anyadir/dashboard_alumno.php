...
<div class="parent">
    ...
    ENVIAR <input type="submit">
        ...
        <?php
$BUSCADOR ="SELECT DISTINCT MATRICULA.ID_ALUMNO,MATRICULA.ID_CURSO,CURSO.NOMBRE,CURSO.DESCRIPCION,CURSO.HORAS,CURSO.F_INICIO,CURSO.F_FINAL,MATRICULA.CALIFICACIONES FROM ALUMNOS,MATRICULA,CURSO WHERE MATRICULA.ID_ALUMNO =$USUARIO AND CURSO.ID_CURSO = MATRICULA.ID_CURSO";
